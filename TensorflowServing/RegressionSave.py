...
tf.app.flags.DEFINE_integer('training_iteration', 400, 'number of training iterations.')
tf.app.flags.DEFINE_integer('model_version', 1, 'version number of the model.')
tf.app.flags.DEFINE_string('work_dir', '/home/satcos/ModelStore/Regression', 'Working directory.')
